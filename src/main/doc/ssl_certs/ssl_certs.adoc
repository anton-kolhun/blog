...
image:../static/image/calendar.png[cal,20] [.greyed]#24 Jul 2025#
...
=== Solution Overview
The most common way to secure your application with an SSL certificate is to introduce a *reverse proxy* (or a load balancer) in front of it.
