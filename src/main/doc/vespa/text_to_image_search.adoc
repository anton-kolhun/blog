...
===  Create link:https://github.com/anton-kolhun/vespa-sample/blob/add-image-search/book/search/query-profiles/book_image_v1.xml[book_image_v1] query-profile as:
----
 ...
 * `BPETokenizer` - Tokenizer used by `ImageEmbedderProcessor`
...
- Feed The Documents +
Popualte `image_url` field in the test link:https://github.com/anton-kolhun/vespa-sample/blob/add-image-search/book/ext/docs.json[documents] with appropriate image URLs and then run:
----
