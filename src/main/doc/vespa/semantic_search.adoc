...
Semantic search is the process of retrieving information by understanding the meaning behind your search, rather than just matching keywords.
...
<query-profile id="book_ann_v1">
    ...
    <field name="ranking.features.query(embedding)">embed(e5, "%{search_term}")</field>
